> This is the documentation of **Laya**, the classifier library bundled in this repository (package `laya`). The smart-factory platform built on it is described in the [SmartMom README](https://github.com/clydechen0228/SmartMom#readme).
